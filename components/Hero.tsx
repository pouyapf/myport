...
const Hero = () => {
  return (
    <div className="md:pb-20 pb-0 pt-10 md:pt-36 ">
      <div>
        <Spotlight
      ...
      <div className=" flex flex-col md:justify-center gap-5 items-center">
        <div className="flex justify-center  relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] gap-7 flex flex-col items-center justify-center">
            <Button
              ...
              className="flex-1 md:hidden text-black dark:text-white border-neutral-200 dark:border-slate-800"
            >
              <Image
        ...
        >
          <Image
            className=" z-50  hidden md:flex w-[700px] h-auto"
            src={"/me.png"}
            width={10000}
            height={10000}
            alt="alt_pic"
